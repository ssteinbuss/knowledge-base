...
During CI, content from the three source repositories is copied under:
    ...
    docs/
    └─ external/
       ├─ rulebook/    # from IDSA-Rulebook/documentation/
       ├─ ram5/        # from RAM5/docs/
       └─ handbook/    # from members-area/OrganizationalHandbook/
...
*   MkDocs auto‑generates **anchors** from headings by slugifying the text (lowercase, spaces → dashes).  
    ...
    ```
    Anchors come from headings; you can also use plugins like **mkdocs‑autorefs** to reference headings by name without paths if enabled. [\[github.com\]](https://github.com/oprypin/mkdocs-literate-nav), [\[squidfunk.github.io\]](https://squidfunk.github.io/mkdocs-material/blog/2026/02/18/mkdocs-2.0/)
